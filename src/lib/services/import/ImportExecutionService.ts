        ...
        for (const row of chunk) {
          try {
            ...
            const notesObj = {
              ...
              productId,
              weightPerUnit: 1,
              quantityUnits: qtyUnits !== undefined ? qtyUnits : quantity,
              ...
              creditNotes: credit !== undefined ? String(credit) : '',
                ...
                if (existingOrder) {
                  await tx.salesOrder.update({
                    ...
                    data: {
                      ...
                      creditAmount: credit !== undefined ? credit : existingOrder.creditAmount,
                      outstanding: credit !== undefined ? credit : existingOrder.outstanding,
            ...
            const createdOrder = await tx.salesOrder.create({
              data: {
                ...
                subtotal: calculatedTotalSellingCost,
                totalAmount: calculatedTotalSellingCost,
                creditAmount: credit !== undefined ? credit : 0,
                outstanding: credit !== undefined ? credit : 0,
                status: status as any,
                notes: JSON.stringify(notesObj),
